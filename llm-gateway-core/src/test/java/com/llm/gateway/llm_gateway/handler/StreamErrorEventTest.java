...
/**
 * Unit tests for the {@link LlmStreamHandler.StreamErrorEvent} record and its JSON serialization
 * format.
 *
 * <p>Verifies that SSE error payloads always contain the mandatory fields: {@code type}, {@code
 * code}, {@code message}, and {@code requestId}.
 */
  ...
  void streamErrorEvent_serialisesToJson() throws Exception {
    LlmStreamHandler.StreamErrorEvent event =
        new LlmStreamHandler.StreamErrorEvent(
            "error", "PROVIDER_ERROR", "Connection refused", "req-abc-123");
