...
/**
 * Chain step 100 — prompt-injection blocking and prompt normalisation.
 * Delegates to {@link PromptSanitizer}; hard violations reject the request,
 * strip/normalisation rewrites flow back into the context.
 */
@Slf4j
@Component
