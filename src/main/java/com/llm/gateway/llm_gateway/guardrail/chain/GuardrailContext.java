...
/**
 * Mutable context object passed along the {@link GuardrailChain}
 * (GoF <b>Chain of Responsibility</b>).
 *
 * <p>Each {@link GuardrailStep} can inspect the prompt, rewrite it via
 * {@link #updatePrompt(String)} (sanitization / redaction), attach warnings, or abort
 * the whole request by throwing
