...
@Slf4j
@Service
@ConditionalOnProperty(prefix = "llm.providers.anthropic", name = "enabled", havingValue = "true", matchIfMissing = true)
public class AnthropicClaudeService implements LlmServiceProvider {
    ...
    @Observed(name = "llm.provider.execute", contextualName = "anthropic-execute",
    ...
    public LlmResponse execute(LlmRequest request) {
        ...
        try {
            ...
            return LlmResponse.builder().provider("Anthropic Claude").model(model)
